...
const clientId = '90362e92685049d9a1ce0a2d23051f4a'; // your clientId
...
if (currentToken.access_token) {
  ...
  renderTemplate("track", "track-template", topTracks);
  renderTemplate("artists", "artists-template", TopArtists);
